...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            [
                'key' => 'category_city_title',
                'description' => 'Название категории',
                'value' => 'Деньги в долг под расписку в {{country}} / {{city}}',
                'type' => 'text',
                'created_at' => $now,
                'updated_at' => $now
            ],
            [
                'key' => 'category_city_content',
                'description' => 'Содержание категории',
                'value' => 'В этой рубрике вы можете увидеть объявления от частных лиц, которым срочно необходимо взять деньги в долг и инвесторов, которые готовы дать деньги в {{country}} / {{city}}.
                Чтобы срочно взять деньги в долг, оставьте объявление на странице: Взять деньги в {{country}} / {{city}}. Чаще всего быстро предоставят займ, если вы сможете оформить залог,
                ...
                странице: Дать деньги в {{country}} / {{city}}. Посмотреть все объявления пользователей, которым необходимы деньги срочно в долг вы можете в рубрике: Взять деньги в долг.
