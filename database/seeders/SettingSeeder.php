    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            [
                ...
                'description' => 'Название категории',
                'value' => 'Деньги в долг под расписку в {{state}}',
                'type' => 'text',
                'created_at' => $now,
                'updated_at' => $now
            ],
            [
                ...
                'value' => 'В этой рубрике вы можете увидеть объявления от частных лиц, которым срочно необходимо взять деньги в долг и инвесторов, которые готовы дать деньги в {{state}}.
                Чтобы срочно взять деньги в долг, оставьте объявление на странице: Взять деньги в {{state}}. Чаще всего быстро предоставят займ, если вы сможете оформить залог,
                ...
                странице: Дать деньги в {{state}}. Посмотреть все объявления пользователей, которым необходимы деньги срочно в долг вы можете в рубрике: Взять деньги в долг.
