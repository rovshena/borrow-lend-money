                ...
                <form method="post" action="{{ route('admin.cities.update', $city) }}" onsubmit="disableSubmitButton();">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{ $city->slug }}" name="slug" required>
                            @error('slug')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('oblast') is-invalid @enderror" id="oblast" value="{{ $city->oblast }}" name="oblast">
                            @error('oblast')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('region') is-invalid @enderror" id="region" value="{{ $city->region }}" name="region">
                            @error('region')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
