                    ...
                    <form action="{{ route('borrow.money.store') }}" method="post" onsubmit="disableSubmitButton();">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea class="form-control form-control-lg @error('content') is-invalid @enderror" name="content" id="content" cols="30" rows="6">{{ old('content') }}</textarea>
                                @error('content')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-lg rounded-pill d-flex align-items-center justify-content-center" id="submit-button">
                                    <span id="loading" class="spinner-border spinner-border-sm d-none mr-2" role="status" aria-hidden="true"></span> {{ __('Publish') }}
                                </button>
                            </div>
                        </div>
                    </form>
